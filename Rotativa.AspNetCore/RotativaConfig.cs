...
namespace Rotativa.AspNetCore
{
    public static class RotativaConfiguration
    {
        ...
        public static void Setup(IHostEnvironment env, string wkhtmltopdfRelativePath = "Rotativa") 
        {
            
            var rotativaPath = Path.Combine(env.ContentRootPath/*.WebRootPath*/, wkhtmltopdfRelativePath);
